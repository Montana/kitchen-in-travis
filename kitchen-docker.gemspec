...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['Montana Mendy, Original Author: Sean Porter']
  spec.email         = ['montana@linux.com, portertech@gmail.com']
  spec.description   = %q{Testing KitchenCI/Chef on Travis CI via Montana Mendy}
